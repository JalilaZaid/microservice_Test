...
- [Project Components](#project-components)
    ...
    - [School Microservice](#course-microservice)
...
The School Microservice manages course-related data and operations, including adding, updating, and retrieving course records.
